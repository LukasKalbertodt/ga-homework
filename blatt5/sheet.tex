...
\emph{Legende for den BinaryHeap}: Der dickere Buchstabe in jedem Knoten des Heaps steht für den Knoten im Graphen. In der zweiten Zeile steht zuerst der Predecessor und dann die Kosten.
